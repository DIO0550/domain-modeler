...
test.each([
  ...
  { text: "state-machine ", expected: 13 },
  { text: "initial: 未検証", expected: 8 },
  { text: "state: 完了", expected: 6 },
  { text: "transition: 未検証", expected: 11 },
  { text: "on 確定する", expected: 2 },
  { text: "terminal ", expected: 8 },
