import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-DXFqSddf.js";import{c as n,l as r,r as i,s as a,t as o,v as s,y as c}from"./sticky-DJZHUrzM.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{r(),n(),i(),l=t(),{fn:u}=__STORYBOOK_MODULE_TEST__,d={event:`注文が確定した`,command:`注文を確定する`,actor:`購買担当`,aggregate:`注文`,policy:`在庫が足りなければ保留する`,readModel:`注文一覧`,externalSystem:`決済サービス`,hotspot:`在庫引当のタイミングは？`},f=(e,t=d[e],n={x:16,y:16})=>{let r=a.of(e);return s.create(c.create(`stk_${e}`),e,t,n,r.defaultSize)},p={component:o,argTypes:{sticky:{control:!1},chrome:{control:!1}},parameters:{layout:`fullscreen`},decorators:[e=>(0,l.jsx)(`div`,{className:`sticky-story`,children:(0,l.jsx)(e,{})})]},m={args:{sticky:f(`event`)}},h={args:{sticky:f(`event`),chrome:{status:`selected`}}},g={args:{sticky:f(`event`,`注文が確定した`),chrome:{status:`editing`,draftText:`注文が確定した`,onDraftChange:u(),onCommit:u()}}},_={decorators:[e=>(0,l.jsx)(`div`,{className:`sticky-story sticky-story--gallery`,children:(0,l.jsx)(e,{})})],render:()=>(0,l.jsx)(l.Fragment,{children:a.all().map(e=>(0,l.jsx)(`div`,{className:`sticky-story__cell`,style:{width:e.defaultSize.width,height:e.defaultSize.height},children:(0,l.jsx)(o,{sticky:f(e.type,d[e.type],{x:0,y:0})})},e.type))})},v={args:{sticky:f(`command`,``)}},y={args:{sticky:f(`policy`,`在庫が足りなければ
保留する`)}},b={args:{sticky:f(`readModel`,`注文番号と顧客名と明細と配送先と支払い状態をすべて一覧に載せ、検索と絞り込みもできるようにする`)}},x={args:{sticky:s.create(c.create(`stk_customsize`),`aggregate`,`注文`,{x:16,y:16},{width:280,height:180})}},S={decorators:[e=>(0,l.jsx)(`div`,{className:`sticky-story sticky-story--gallery`,children:(0,l.jsx)(e,{})})],render:()=>(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(`div`,{className:`sticky-story__cell`,style:{width:120,height:80},children:(0,l.jsx)(o,{sticky:f(`actor`,``,{x:0,y:0})})}),(0,l.jsx)(`div`,{className:`sticky-story__cell`,style:{width:140,height:100},children:(0,l.jsx)(o,{sticky:f(`hotspot`,`在庫引当は注文確定の前か後か、それとも非同期か、判断が分かれている`,{x:0,y:0})})}),(0,l.jsx)(`div`,{className:`sticky-story__cell`,style:{width:60,height:40},children:(0,l.jsx)(o,{sticky:s.create(c.create(`stk_tiny`),`event`,`あふれる本文を最小サイズに入れる`,{x:0,y:0},{width:60,height:40})})}),(0,l.jsx)(`div`,{className:`sticky-story__cell`,style:{width:160,height:100},children:(0,l.jsx)(o,{sticky:f(`externalSystem`,`決済
サービス
